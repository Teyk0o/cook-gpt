...
class RecipesParser {
    static async parseSearchResults(dom, baseUrl, ingredients) {
        ...
        const validRecipes = recipes.filter(isDefined);
        // Si des ingrédients sont spécifiés, filtrez les recettes
        if (ingredients && ingredients.length) {
            console.log('test');
            return validRecipes.filter(recipe => ingredients.every(ingredient => recipe.ingredients?.includes(ingredient)));
        }
        return validRecipes;
    }
