...
class MarmitonQueryBuilder {
    ...
    withIngredients(ingredients) {
        if (!Array.isArray(ingredients) || !ingredients.every(item => typeof item === 'string')) {
            throw new TypeError("Expected ingredients to be an array of strings got " + typeof ingredients + " instead for " + ingredients);
        }
        this.queryString.append('ingredients', ingredients.join(','));
        return this;
    }
    /**
